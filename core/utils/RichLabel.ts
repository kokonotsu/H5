module game
{
     ...
     */
    export class Label extends Laya.Text
    {
        constructor()
        {
            super();
        ...
        renderText(begin, visibleLineCount)
        {
            ...
            graphics.clear(true);
            var ctxFont = (this.italic ? "italic " : "") + (this.bold ? "bold " : "") + this.fontSize + "px " + (Laya.Browser.onIPhone ? (laya.display.Text._fontFamilyMap[this.font] || this.font) : this.font);
